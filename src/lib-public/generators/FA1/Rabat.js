import { createHeader, createLabelText, createSection, formatText, generateTwoColumns, getContentTable, getTable, } from '../../../shared/PDF-functions';
import FormatTyp, { Position } from '../../../shared/enums/common.enum';
export function generateRabat(invoice) {
    const faRows = getTable(invoice.FaWiersze?.FaWiersz);
    const result = [];
    const definedHeader = [
