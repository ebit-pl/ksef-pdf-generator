import { createHeader, createLabelText, createLabelTextArray, createSection, createSubHeader, generateColumns, generateTwoColumns, getContentTable, getTable, } from '../../../shared/PDF-functions';
