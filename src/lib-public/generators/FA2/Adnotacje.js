    ...
    if (adnotacje) {
        ...
        if (zwolnienie?.P_19?._text === '1') {
            ...
            if (zwolnienie.P_19A?._text) {
                firstColumn.push(createLabelText('Podstawa zwolnienia od podatku: ', 'Przepis ustawy albo aktu wydanego na podstawie ustawy, na podstawie którego podatnik stosuje zwolnienie od podatku'));
                firstColumn.push(createLabelText('Przepis ustawy albo aktu wydanego na podstawie ustawy: ', zwolnienie.P_19A._text));
            }
            if (zwolnienie.P_19B?._text) {
                firstColumn.push(createLabelText('Podstawa zwolnienia od podatku: ', 'Przepis dyrektywy 2006/112/WE, który zwalnia od podatku taką dostawę towarów lub takie świadczenie usług'));
                firstColumn.push(createLabelText('Przepis dyrektywy: ', zwolnienie.P_19B._text));
            }
            if (zwolnienie.P_19C?._text) {
                firstColumn.push(createLabelText('Podstawa zwolnienia od podatku: ', 'Inna podstawa prawna wskazującą na to, że dostawa towarów lub świadczenie usług korzysta ze zwolnienia'));
