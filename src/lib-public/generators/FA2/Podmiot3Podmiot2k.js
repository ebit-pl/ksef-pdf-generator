import { createHeader, createLabelText, generateTwoColumns, getTable, hasValue, } from '../../../shared/PDF-functions';
...
export function generateDaneIdentyfikacyjneTPodmiot3Dto(podmiot2KDto, index) {
    ...
    if (hasValue(podmiot1.NrEORI) ||
        ...
        result.push(...createHeader('Dane identyfikacyjne'), createLabelText('Numer EORI: ', podmiot1.NrEORI), createLabelText('Rola: ', getRolaString(podmiot1.Rola, 2)), createLabelText('Rola inna: ', podmiot1.OpisRoli), createLabelText('Udział: ', podmiot1.Udzial, FormatTyp.Currency6));
    }
