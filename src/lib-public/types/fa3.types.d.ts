import { KodFormularza as KodFormularzaFa1, Rozliczenie as RozliczenieFa1, Stopka as StopkaFa1, Umowy as UmowyFa1, Zamowienia as ZamowieniaFa1, Zenia as ZeniaFa1 } from './fa1.types';
...
export interface TerminOpis {
    Ilosc?: FP;
    Jednostka?: FP;
    ZdarzeniePoczatkowe?: FP;
}
...
export interface Rozliczenie extends RozliczenieFa1 {
}
...
export interface Kol {
    _attributes?: KolAttributes;
    NKom?: FP;
}
export interface KolAttributes {
    Typ?: string;
}
...
//# sourceMappingURL=fa3.types.d.ts.map