...
export function normalizeCurrencySeparator(value) {
    if (!value) {
        return '';
    }
...
export function replaceDotWithCommaIfNeeded(value) {
    let copyValue = '';
...
export function getKraj(code) {
    if (Kraj[code]) {
        return Kraj[code];
    }
    return code;
}
export function getTStawkaPodatku(code, version) {
